...
void parseGNRMC() {
    ...
    #ifdef DEBUG
           gpsSerial.print("Last fix"); gpsSerial.println(msg_GNRMC.lastFix);
           gpsSerial.print("Last status"); gpsSerial.println(msg_GNRMC.status);
           gpsSerial.print("Lat");gpsSerial.print(msg_GNRMC.latD); gpsSerial.println(msg_GNRMC.lat);
           gpsSerial.print("lng "); gpsSerial.print(msg_GNRMC.lngD); gpsSerial.println(msg_GNRMC.lng);
           gpsSerial.print("date "); gpsSerial.println(msg_GNRMC.date);
...
void parseGNGSA() {
    ...
    if (msg_GNGSA.statusFix == 3 || msg_GNGSA.statusFix == 2) gps_ready = true;
         ...
         gpsSerial.print(msg_GNGSA.statusFix);

    #ifdef DEBUG
     gpsSerial.print("status fix is");
      if (msg_GNGSA.statusFix == 3) gpsSerial.println(" 3D FIX");
      gpsSerial.print("num of sat"); gpsSerial.println(msg_GNGSA.numSat);
    #endif
}
